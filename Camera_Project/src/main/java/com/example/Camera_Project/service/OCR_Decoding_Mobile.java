...
@Service
public class OCR_Decoding_Mobile {
...
{
	String fileData = reduceImageSize(convertBase64ToGrayscale(imageBase64),600,800);
	//System.out.println("GrayScale:"+convertBase64ToGrayscale(imageBase64));
    byte[] byteArr = Base64Utils.decodeFromString(fileData);
    InputStream inputStream = new ByteArrayInputStream(byteArr); // byte[] byteArr 
