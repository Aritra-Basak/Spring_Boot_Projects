...
<!-- <button id="captureButton" onclick="stopCamera()" class="btn btn-success my-4">Stop</button> -->
   <div class="webcam d-flex justify-content-evenly">
        ...
        <div class="grid-item">
        	<div>
			    <h1 id="countHeader">Scan Progress</h1>
			    <div style="background-color: #C1ECE4;margin-top:4%;height: 100px;">
			    <div class="d-flex flex-column" style="margin:5%"  >
<%-- 			     <form:form id="docForm" action="<%=request.getContextPath()%>/saveDetails" method="POST"> --%>
				<form:form id="docForm" action="./saveDetails" method="POST">
					    <div class="text-center"><label class="form-label" style="font-size: 20px;">Please Scan your QR code.</label></div>	
							 <input type="text" class="form-control" id="qrString" name="qrString" autofocus autocomplete="off">
							 <button type="submit" class="btn btn-info my-2" style="display:none"><strong>Submit</strong></button>
				</form:form>
			    </div>
			     ...
			     <div id="instructions" class="fw-bold" style="font-size:12px;margin-top:180px">
				<h4>Instructions</h4>
	            <ul>
	            	<li>Hold the Aadhaar Card and scan the QR with the Scanner.</li>
	            	<li>আধার কার্ডটি ধরে রাখুন এবং স্ক্যানার দিয়ে QR স্ক্যান করুন। </li>
	            </ul>
       		...
       		<h1>Details</h1>
       					...
       					<div class="d-flex flex-column" style="margin:7%" id="detailsForm">
								<div class="mb-3" >
										  ...
										  <input type="text" class="form-control" id="patientName" name="patientName" readonly value="${qrval.name}">
								</div>
								<div class="mb-3" >
										  ...
										  <input type="text" class="form-control" id="aadhaarNumber" name="aadhaarNumber" onchange="startAll()" readonly value="${qrval.lastFourDigit}">
								</div>
								<div class="mb-3" >
								
										  <label class="form-label" style="font-size: 20px;margin-left: -88%;">DOB<i class="fa fa-asterisk" style="color:red">*</i></label>
										  <input type="text" class="form-control" id="dOb" name="dOb" readonly value="${qrval.dateOfBirth}">
								</div>
								
								<div class="mb-3" >
										  <label class="form-label" style="font-size: 20px;margin-left: -81%;">Gender<i class="fa fa-asterisk" style="color:red">*</i></label>
										  <input type="text" class="form-control" id="gender" name="gender" readonly value="${qrval.gender}">
								</div>
								<div class="mb-3" >
